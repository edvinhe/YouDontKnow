...
void HandleTextField::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (HandleTextField::*_t)(QVariant );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&HandleTextField::setTextField)) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject HandleTextField::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_HandleTextField.data,
      qt_meta_data_HandleTextField,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *HandleTextField::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_HandleTextField.stringdata0))
        return static_cast<void*>(const_cast< HandleTextField*>(this));
